            ...
            <div class="col-xl-12">
                <div class="inner-content clearfix">
                    <div class="title text-center">
                       <h1>Gear Measuring Instruments</h1>
                    </div>
                </div>
            </div>
        </div>
			...
			<div class="col-xl-9 col-lg-12">
				<div class="row collapse-info" id="collapseOpen_1">
					...
					<div class="col-xl-5 col-lg-12 f-r">
						<div class="project-info" id="project-info">
							<div class="title">
								<h3>DO 3 PC</h3>
								<p>Measuring instrument for complete testing of form geometric deviations of involute gearing, i.e. profile, lead, pitch and radial run-out, dia over ball, span, etc. Evaluation is realized according to DIN, AGMA, ISO and GOST standards with PC protocol print-out. The tester's accuracy is attested by statistics SW qs-stat 3.2 and VDI/VDE. Optional SW available for inspection of Hob after resharpening, PC based automatic measuring cycle.</p>
							</div>							
						</div>
					</div>  
				...
				<div class="row collapse-info" id="collapseOpen_2">
					...
					<div class="col-xl-5 col-lg-12 f-r">
						<div class="project-info" id="project-info">
							<div class="title">
								<h3>DO 300/500 CNC</h3>
								<p>Measuring instrument for complete testing of form geometric deviations of spur involute gearing, ie. Pitch, profile, helix angle, radial run out and check dimensions, up to dia.500mm.</p>
							</div>							
						</div>
					</div>  
					<div class="col-xl-12 col-lg-12">
						<table class="table table-striped borderless">
							...
							<tbody>
								...
								<tr>
									...
									<td>Max angle of tooth declination	</td>
									<td>330 mm</td>
									<td>3800 mm</td>
								</tr><tr>
